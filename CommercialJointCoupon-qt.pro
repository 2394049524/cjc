TEMPLATE = app
TARGET = CommercialJointCoupon-qt
VERSION = 0.8.5
...
QT += testlib
TARGET = CommercialJointCoupon-qt_test
...
macx:ICON = src/qt/res/icons/CommercialJointCoupon.icns
macx:TARGET = "CommercialJointCoupon-Qt"
